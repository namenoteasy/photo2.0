...
const HOST = "http://127.0.0.1:8360";
...
const api = {
  ...
  getDaily: "/api/index/getDaily", // 精选详情
  // 需要登录的接口
  login: "/api/login/index", // 登录接口，code换取openid
  getUserInfo: "/api/user/getUserInfo", // 获取用户信息
  getCollectArticle: "/api/user/getCollectArticle", // 获取用户收藏文章
  getCommentArticle: "/api/user/getCommentArticle", // 获取用户评论文章
  // 文章相关
